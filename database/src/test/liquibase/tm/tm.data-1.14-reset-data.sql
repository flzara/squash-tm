...
DELETE FROM PARTY_PREFERENCE;
DELETE FROM BUGTRACKER_PROJECT;
DELETE FROM CHART_PROJECT_SCOPE;
DELETE FROM CRLN_RELATIONSHIP_CLOSURE;
DELETE FROM CUSTOM_REPORT_CHART_BINDING;
DELETE FROM CUSTOM_REPORT_DASHBOARD;
DELETE FROM CUSTOM_REPORT_FOLDER;
DELETE FROM CRLN_RELATIONSHIP;
DELETE FROM CUSTOM_REPORT_LIBRARY_NODE;
DELETE FROM CUSTOM_REPORT_LIBRARY;
DELETE FROM CHART_SCOPE;
DELETE FROM CHART_AXIS_COLUMN;
DELETE FROM CHART_FILTER_VALUES;
DELETE FROM CHART_FILTER;
DELETE FROM CHART_MEASURE_COLUMN;
DELETE FROM CHART_COLUMN_ROLE;
DELETE FROM CHART_COLUMN_PROTOTYPE;
DELETE FROM CHART_DEFINITION;
DELETE FROM CHART_QUERY;
...
DELETE FROM SYNC_REQUIREMENT_CREATION;
DELETE FROM SYNC_REQUIREMENT_UPDATE;
...
DELETE FROM REQUIREMENT_SYNC_EXTENDER;
