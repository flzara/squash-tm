...
/**
 * Unchecked wrapper for a remote exception.
 *
...
public class BugTrackerRemoteException extends BugTrackerManagerException {
	...
	public BugTrackerRemoteException(String message, Throwable cause) {
		super(message, cause);
	}

	public BugTrackerRemoteException(Throwable cause) {
		super(cause);
	}
