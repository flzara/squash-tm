...
/**
 *
 * Triggered after an ActionWordLibraryNode was attached to another one.
 * It will attach that node and its subtree to the ancestors of that node.
 *
 * @author qtran
 *
 */
public class AWLNAfterAttach extends TriggerAdapter {
