 ...
 *
 */
public class TCLNAfterUpdatingDatasets extends TriggerAdapter {

	private static final String SQL = "UPDATE TEST_CASE_LIBRARY_NODE TCLN " +
		"SET "+
		"TCLN.LAST_MODIFIED_BY = (SELECT D.LAST_MODIFIED_BY FROM DATASET D WHERE D.TEST_CASE_ID =? ) , " +
		"TCLN.LAST_MODIFIED_ON = (SELECT D.LAST_MODIFIED_ON FROM DATASET D WHERE D.TEST_CASE_ID =? ) " +
		"WHERE TCLN.TCLN_ID = ? " +
		";";
