...
/**
 * Thrown when trying to disable Xsquash4Jira Plugin in a project that is linked to at least one RemoteSynchronisation.
 *
 * @author jprioux
 *
 */
public class CannotDisablePluginLinkedToSynchronisationException extends ActionException {
	...
	public CannotDisablePluginLinkedToSynchronisationException(Exception cause) {
		super(cause);
	}
