...
public class SpecializedEntityType {
	/**
	 * Used in {@link QueryColumnPrototype} : when the EntityType referenced by this ColumnPrototype may support different roles depending
	...
	public enum EntityRole {
		...
		// **** new types since 1.20 *****
		TEST_CASE_PROJECT,
		REQUIREMENT_PROJECT,
		CAMPAIGN_PROJECT,

		TEST_CASE_ATTLIST,
		REQUREMENT_VERSION_ATTLIST,
		CAMPAIGN_ATTLIST,
