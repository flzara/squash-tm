...
public class SyncRequirementCreation extends RequirementAuditEvent {

	private String source;	// the url from where the requirement was pulled in
	
	public SyncRequirementCreation(){
		super();
	}
	
	public SyncRequirementCreation(RequirementVersion requirementVersion, String author) {
