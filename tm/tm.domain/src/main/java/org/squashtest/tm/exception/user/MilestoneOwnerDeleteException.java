...
public class MilestoneOwnerDeleteException extends ActionException {
	...
	public MilestoneOwnerDeleteException(Exception ex) {
		super(ex);
	}

	public MilestoneOwnerDeleteException(String message) {
		super(message);
	}

	public MilestoneOwnerDeleteException(String message, Exception ex) {
		super(message, ex);
	}
