...
/**
 * 
 * Those objects can bind or unbind with milestones. They are the physical support of such binding, to which other
 * {@link MilestoneMember} can delegate to if they don't hold the milestone themselves.
 * 
 * @author bsiri
 * 
 */
