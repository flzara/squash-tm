...
/**
 * This constraint ensures that start date and end date are consistent.
 * @author Alix Pierre
 * @author Johan Lor
 *
 */
...
@Constraint(validatedBy = ScheduledTimePeriodIsScheduledPeriodValidValidator.class)
public @interface IsScheduledPeriodValid {
