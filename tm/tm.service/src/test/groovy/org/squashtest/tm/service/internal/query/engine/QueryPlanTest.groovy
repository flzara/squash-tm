...
import org.squashtest.tm.service.internal.query.engine.QueryPlan.QueryPlanJoinIterator;
...
class QueryPlanTest extends Specification {
	...
	def "should trim to fit the chart definition"(){
		...
		def chartDef = new Query(rootEntity : rootEntity, targetEntities : targetEntities)
		tree.trim(chartDef)
