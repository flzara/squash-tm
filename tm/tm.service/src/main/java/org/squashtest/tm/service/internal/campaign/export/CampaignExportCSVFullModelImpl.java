...
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_EXEC_CUF_;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_EXEC_STATUS;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_EXEC_STEP_COMMENT;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_EXEC_STEP_DATE;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_EXEC_STEP_ISSUES;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_EXEC_STEP_STATUS;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_EXEC_STEP_USER;
...
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_STEP_CUF;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_STEP_ID;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_STEP_NUM;
import static org.squashtest.tm.service.internal.campaign.export.CampaignExportCSVConstants.HEADER_STEP_REQ;
...
public class CampaignExportCSVFullModelImpl extends AbstractCampaignExportCSVModel {
	...
	public Row getHeader() {
		...
		headerCells.add(new CellImpl(HEADER_STEP_ID));
		headerCells.add(new CellImpl(HEADER_STEP_NUM));
		headerCells.add(new CellImpl(HEADER_STEP_REQ));
		headerCells.add(new CellImpl(HEADER_EXEC_STEP_STATUS));
		headerCells.add(new CellImpl(HEADER_EXEC_STEP_DATE));
		headerCells.add(new CellImpl(HEADER_EXEC_STEP_USER));
		headerCells.add(new CellImpl(HEADER_EXEC_STEP_ISSUES));
		headerCells.add(new CellImpl(HEADER_EXEC_STEP_COMMENT));
		...
		for (CustomFieldDto cufModel : esCUFModel) {
			headerCells.add(new CellImpl(HEADER_STEP_CUF + cufModel.getCode()));
		}
