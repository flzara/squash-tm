...
public enum RequirementSearchSheetColumn implements TemplateColumn {
	...
	private RequirementSearchSheetColumn() {
		this.header = name();
		processingMode = OPTIONAL;
	}

	private RequirementSearchSheetColumn(ColumnProcessingMode processingMode) {
		this.header = name();
		this.processingMode = processingMode;
	}

	private RequirementSearchSheetColumn(String header, ColumnProcessingMode processingMode) {
		this.header = header;
		this.processingMode = processingMode;
	}
