...
<layout:tree-picker-layout workspaceTitleKey="workspace.test-case.title"
  ...
  <jsp:attribute name="tree">
    <tree:linkables-tree workspaceType="requirement" elementType="test-case" elementId="${ testCase.id }"
                         id="linkable-requirements-tree" rootModel="${ linkableLibrariesModel }"/>
  </jsp:attribute>
  ...
  <jsp:attribute name="subPageTitle">
    <h2><c:out value="${testCase.name}"/>&nbsp;:&nbsp;<f:message
      key="squashtm.library.verifiedrequirements.title"/></h2>
  </jsp:attribute>

  <jsp:attribute name="subPageButtons">
    <f:message var="backButtonLabel" key="label.Back"/>
    <input type="button" class="sq-btn button" id="back" value="${ backButtonLabel }"
