...
<layout:tree-picker-layout workspaceTitleKey="workspace.test-case.title"
  ...
  <jsp:attribute name="tree">
		<tree:linkables-tree workspaceType="requirement" elementType="teststep" elementId="${ testStep.id }"
  ...
  <jsp:attribute name="subPageTitle">
		<h2><f:message key="label.stepNumber"/>${testStep.index +1}&nbsp;:&nbsp;<f:message
      key="title.verifiedrequirementsManager.test-steps"/></h2>
	</jsp:attribute>
