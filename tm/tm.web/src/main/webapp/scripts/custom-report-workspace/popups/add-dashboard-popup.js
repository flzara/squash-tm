 ...
 */
define(['jquery','backbone', 'tree', '../permissions-rules', 'jquery.squash.formdialog'], function($,Backbone, zetree, rules){
	...
	function init(){
		...
		var dialog = $("#add-dashboard-dialog").formDialog();
		var tree = zetree.get();
...
//				dialog.formDialog('setState', errorState);
				...
				dialog.find("#new-dashboard-tree-button").val(name);
			}
		});
