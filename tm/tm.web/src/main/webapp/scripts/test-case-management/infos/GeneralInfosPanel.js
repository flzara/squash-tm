				...
				initialize : function(options) {
					...
					if(this.settings.writable){
						...
						this.natureEditable = new SelectJEditable({
							...
							jeditableSettings : {
								data : self._unescapeData(confman.toJeditableSelectFormat(this.settings.testCaseNatures.items, {"code" : "friendlyLabel"})),
						...
						this.typeEditable = new SelectJEditable({
							...
							jeditableSettings : {
								data : self._unescapeData(confman.toJeditableSelectFormat(this.settings.testCaseTypes.items, {"code" : "friendlyLabel"})),
								onsubmit : function(){
