...
define(["require", "dashboard/basic-objects/model", "dashboard/basic-objects/timestamp-label",
		...
		"./bound-description-pie", "./coverage-donut", "./validation-donut", "squash.translator", "../dashboard-utils"],
	function (require, StatModel, Timestamp, SuperMasterView, Summary, BoundTestCasePie, StatusPie, CriticalityPie,
						BoundDescriptionPie, CoverageDonut, ValidationDonut, translator, utils) {
