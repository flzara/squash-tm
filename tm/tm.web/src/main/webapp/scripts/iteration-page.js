...
require(["common"], function () {
	...
	require(["jquery", "underscore", "app/pubsub", "squash.basicwidgets", "contextual-content-handlers",
			...
			"favorite-dashboard", "./user-account/user-prefs", "dashboard/second-level-wreqr", "test-automation/auto-execution-buttons-panel", "jquery.squash.formdialog", "test-suite/execution-buttons-panel"],
