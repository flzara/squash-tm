 ...
 */
define(["backbone", "custom-report-workspace/views/dashboardView", "home-workspace/default-dashboard-view",
		"user-account/user-prefs", "app/AclModel", "tree", "custom-report-workspace/utils", "backbone.wreqr"],
	function (Backbone, DashboardView, CantShowView, userPrefs, AclModel, zetree, chartUtils, backboneWreqr) {
		'use strict';
		var View = Backbone.View.extend({
			...
			initView: function () {
				...
				var selected = this.tree ? this.tree.jstree("get_selected") : [];
			...
			initializeEvents: function () {
				var wreqr = squashtm.app.wreqr || new backboneWreqr.EventAggregator();
				var self = this;
