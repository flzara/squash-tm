...
define([], function(){
	...
	return {
		...
		'testcases.scripted' : root + '/scripted-test-cases/{\\d+}',
		'testcases.scripted.validate' : root + '/scripted-test-cases/validate',
		...
		'custom-report-report-binding-replace-report' : root + '/custom-report-report-binding-replace-report/{\\d+}/{\\d+}',
